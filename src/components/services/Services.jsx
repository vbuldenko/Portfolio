        ...
        <section className="services section" id="services">
            ...
            <div className="services__container container grid">
                ...
                <div className="services__content">
                    ...
                    <span className="services__button" onClick={() => toggleModalTab(2)}>
                        View More
                        <i className="uil uil-arrow-right services__button-icon"></i>
                    </span>
                ...
                <div className="services__content">
                    ...
                    <span className="services__button" onClick={() => toggleModalTab(3)}>
                        View More{" "}
                        <i className="uil uil-arrow-right services__button-icon"></i>
                    </span>

                    <div className={modalState === 3 ? "services__modal active-modal" : "services__modal"}>
                        <div className="services__modal-content">
                            <i className="uil uil-times services__modal-close" onClick={() => toggleModalTab(0)}></i>
